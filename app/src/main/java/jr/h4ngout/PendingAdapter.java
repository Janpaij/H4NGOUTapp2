...
public class PendingAdapter extends ArrayAdapter {
    ...
    public PendingAdapter(@NonNull Context context, int resource) {
        super(context, resource);
    }


    public void add(@Nullable PendingGetSet object) {
        super.add(object);
        list.add(object);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(row == null)
        {
            ...
            row = layoutInflater.inflate(R.layout.row_layout_pending_invites, parent, false);
            eventHolder = new EventHolder();
            eventHolder.event_name = (Button) row.findViewById(R.id.GroupName);
            eventHolder.going = (ImageButton) row.findViewById(R.id.search);
            eventHolder.notgoing = (ImageButton) row.findViewById(R.id.cross);
        ...
        final PendingGetSet myEvents = (PendingGetSet) this.getItem(position);
